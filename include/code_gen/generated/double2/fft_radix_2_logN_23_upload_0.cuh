...
template<>
__global__ void fft_radix_2<double2, 23, 0, 0, 0>(double2* inputs, double2* outputs, double2* twiddle, double2* checksum_DFT, int BS, int thread_bs) {
    int bid_cnt = 0;
    ...
    global_k += tx / 32;
        ...
        delta_angle = twiddle[8388607 + global_j * (8)];
        angle = twiddle[8388607 + global_j * global_k];
...
#include "../../../TurboFFT_radix_2_template.h"
template<>
__global__ void fft_radix_2<double2, 23, 0, 1, 0>(double2* inputs, double2* outputs, double2* twiddle, double2* checksum_DFT, int BS, int thread_bs) {
    int bid_cnt = 0;
    ...
    rPtr_2[0] = *(checksum_DFT + 128 - 2 + tx + 0);
    shPtr[tx + 0] = rPtr_2[0];
    ...
    gPtr += (bx % BS * 8388608);
        ...
        // tmp_3.x += bid_cnt * (rPtr[0].x + rPtr[0].y) * 128;
    ...
    global_k += tx / 32;
        ...
        turboFFT_ZMUL(tmp, rPtr[1],r[(8 + tx / 32) % 3])
        tmp_1.y -= (tmp.x + tmp.y);
        tmp_3.y -= (tmp.y + tmp.x) * bid_cnt;
        // turboFFT_ZMUL_NACC(tmp_1,  rPtr[1], r[(8 + tx / 32) % 3])
        // turboFFT_ZMUL_NACC(tmp_3,  rPtr[1], r[(8 + tx / 32) % 3])
        ...
        turboFFT_ZMUL(tmp, rPtr[9],r[(24 + tx / 32) % 3])
        tmp_1.y -= (tmp.x + tmp.y);
        tmp_3.y -= (tmp.y + tmp.x) * bid_cnt;
        // turboFFT_ZMUL_NACC(tmp_1,  rPtr[9], r[(24 + tx / 32) % 3])
        // turboFFT_ZMUL_NACC(tmp_3,  rPtr[9], r[(24 + tx / 32) % 3])
        ...
        turboFFT_ZMUL(tmp, rPtr[5],r[(40 + tx / 32) % 3])
        tmp_1.y -= (tmp.x + tmp.y);
        tmp_3.y -= (tmp.y + tmp.x) * bid_cnt;
        // turboFFT_ZMUL_NACC(tmp_1,  rPtr[5], r[(40 + tx / 32) % 3])
        // turboFFT_ZMUL_NACC(tmp_3,  rPtr[5], r[(40 + tx / 32) % 3])
        ...
        turboFFT_ZMUL(tmp, rPtr[13],r[(56 + tx / 32) % 3])
        tmp_1.y -= (tmp.x + tmp.y);
        tmp_3.y -= (tmp.y + tmp.x) * bid_cnt;
        // turboFFT_ZMUL_NACC(tmp_1,  rPtr[13], r[(56 + tx / 32) % 3])
        // turboFFT_ZMUL_NACC(tmp_3,  rPtr[13], r[(56 + tx / 32) % 3])
        ...
        turboFFT_ZMUL(tmp, rPtr[3],r[(72 + tx / 32) % 3])
        tmp_1.y -= (tmp.x + tmp.y);
        tmp_3.y -= (tmp.y + tmp.x) * bid_cnt;
        // turboFFT_ZMUL_NACC(tmp_1,  rPtr[3], r[(72 + tx / 32) % 3])
        // turboFFT_ZMUL_NACC(tmp_3,  rPtr[3], r[(72 + tx / 32) % 3])
        ...
        turboFFT_ZMUL(tmp, rPtr[11],r[(88 + tx / 32) % 3])
        tmp_1.y -= (tmp.x + tmp.y);
        tmp_3.y -= (tmp.y + tmp.x) * bid_cnt;
        // turboFFT_ZMUL_NACC(tmp_1,  rPtr[11], r[(88 + tx / 32) % 3])
        // turboFFT_ZMUL_NACC(tmp_3,  rPtr[11], r[(88 + tx / 32) % 3])
        ...
        turboFFT_ZMUL(tmp, rPtr[7],r[(104 + tx / 32) % 3])
        tmp_1.y -= (tmp.x + tmp.y);
        tmp_3.y -= (tmp.y + tmp.x) * bid_cnt;
        // turboFFT_ZMUL_NACC(tmp_1,  rPtr[7], r[(104 + tx / 32) % 3])
        // turboFFT_ZMUL_NACC(tmp_3,  rPtr[7], r[(104 + tx / 32) % 3])
        ...
        turboFFT_ZMUL(tmp, rPtr[15],r[(120 + tx / 32) % 3])
        tmp_1.y -= (tmp.x + tmp.y);
        tmp_3.y -= (tmp.y + tmp.x) * bid_cnt;
        // turboFFT_ZMUL_NACC(tmp_1,  rPtr[15], r[(120 + tx / 32) % 3])
        // turboFFT_ZMUL_NACC(tmp_3,  rPtr[15], r[(120 + tx / 32) % 3])
        ...
        // 1's vector
        // tmp.x = (tx / 32 == 0) ? (rPtr_3[0].y + rPtr_3[0].x) * 128: 0;
        // tmp.y = (tx / 32 == 0) ? (abs(rPtr_3[0].y) + abs(rPtr_3[0].x)) * 128: 0;
        tmp = tmp_1;
        tmp_1.y += tmp.x;
...
#include "../../../TurboFFT_radix_2_template.h"
template<>
__global__ void fft_radix_2<double2, 23, 0, 1, 1>(double2* inputs, double2* outputs, double2* twiddle, double2* checksum_DFT, int BS, int thread_bs) {
    int bid_cnt = 0;
