...
template<>
__global__ void fft_radix_2<double2, 14, 0, 0, 0>(double2* inputs, double2* outputs, double2* twiddle, double2* checksum_DFT, int BS, int thread_bs) {
    int bid_cnt = 0;
    ...
    for(bid = (blockIdx.x / tb_gap) * tb_gap * thread_bs + blockIdx.x % tb_gap;
                bid_cnt < thread_bs && bid < (16384 * BS + 2048 - 1) / 2048; bid += delta_bid)
    {
    bid_cnt += 1;
...
#include "../../../TurboFFT_radix_2_template.h"
template<>
__global__ void fft_radix_2<double2, 14, 0, 1, 0>(double2* inputs, double2* outputs, double2* twiddle, double2* checksum_DFT, int BS, int thread_bs) {
    int bid_cnt = 0;
    ...
    global_k += tx / 16;
        ...
        turboFFT_ZMUL(tmp, rPtr[1],r[(16 + tx / 16) % 3])
        tmp_1.y -= (tmp.x + tmp.y);
        tmp_3.y -= (tmp.y + tmp.x) * bid_cnt;
        // turboFFT_ZMUL_NACC(tmp_1,  rPtr[1], r[(16 + tx / 16) % 3])
        // turboFFT_ZMUL_NACC(tmp_3,  rPtr[1], r[(16 + tx / 16) % 3])
        ...
        turboFFT_ZMUL(tmp, rPtr[2],r[(32 + tx / 16) % 3])
        tmp_1.y -= (tmp.x + tmp.y);
        tmp_3.y -= (tmp.y + tmp.x) * bid_cnt;
        // turboFFT_ZMUL_NACC(tmp_1,  rPtr[2], r[(32 + tx / 16) % 3])
        // turboFFT_ZMUL_NACC(tmp_3,  rPtr[2], r[(32 + tx / 16) % 3])
        ...
        turboFFT_ZMUL(tmp, rPtr[3],r[(48 + tx / 16) % 3])
        tmp_1.y -= (tmp.x + tmp.y);
        tmp_3.y -= (tmp.y + tmp.x) * bid_cnt;
        // turboFFT_ZMUL_NACC(tmp_1,  rPtr[3], r[(48 + tx / 16) % 3])
        // turboFFT_ZMUL_NACC(tmp_3,  rPtr[3], r[(48 + tx / 16) % 3])
        ...
        turboFFT_ZMUL(tmp, rPtr[4],r[(64 + tx / 16) % 3])
        tmp_1.y -= (tmp.x + tmp.y);
        tmp_3.y -= (tmp.y + tmp.x) * bid_cnt;
        // turboFFT_ZMUL_NACC(tmp_1,  rPtr[4], r[(64 + tx / 16) % 3])
        // turboFFT_ZMUL_NACC(tmp_3,  rPtr[4], r[(64 + tx / 16) % 3])
        ...
        turboFFT_ZMUL(tmp, rPtr[5],r[(80 + tx / 16) % 3])
        tmp_1.y -= (tmp.x + tmp.y);
        tmp_3.y -= (tmp.y + tmp.x) * bid_cnt;
        // turboFFT_ZMUL_NACC(tmp_1,  rPtr[5], r[(80 + tx / 16) % 3])
        // turboFFT_ZMUL_NACC(tmp_3,  rPtr[5], r[(80 + tx / 16) % 3])
        ...
        turboFFT_ZMUL(tmp, rPtr[7],r[(112 + tx / 16) % 3])
        tmp_1.y -= (tmp.x + tmp.y);
        tmp_3.y -= (tmp.y + tmp.x) * bid_cnt;
        // turboFFT_ZMUL_NACC(tmp_1,  rPtr[7], r[(112 + tx / 16) % 3])
        // turboFFT_ZMUL_NACC(tmp_3,  rPtr[7], r[(112 + tx / 16) % 3])
        ...
        // 1's vector
        // tmp.x = (tx / 16 == 0) ? (rPtr_3[0].y + rPtr_3[0].x) * 128: 0;
        // tmp.y = (tx / 16 == 0) ? (abs(rPtr_3[0].y) + abs(rPtr_3[0].x)) * 128: 0;
        tmp = tmp_1;
        tmp_1.y += tmp.x;
...
#include "../../../TurboFFT_radix_2_template.h"
template<>
__global__ void fft_radix_2<double2, 14, 0, 1, 1>(double2* inputs, double2* outputs, double2* twiddle, double2* checksum_DFT, int BS, int thread_bs) {
    int bid_cnt = 0;
