...
template<>
__global__ void fft_radix_2<double2, 29, 0, 0, 0>(double2* inputs, double2* outputs, double2* twiddle, double2* checksum_DFT, int BS, int thread_bs) {
    int bid_cnt = 0;
    ...
    global_k += tx / 8;
        ...
        delta_angle = twiddle[536870911 + global_j * (64)];
        angle = twiddle[536870911 + global_j * global_k];
        ...
        turboFFT_ZMUL(angle, tmp, delta_angle);
            ...
            *(gPtr + 167772160) = rPtr[9];
            rPtr_4[5].x += rPtr[9].x;
            rPtr_4[5].y += rPtr[9].y;
            
            *(gPtr + 201326592) = rPtr[10];
            rPtr_4[6].x += rPtr[10].x;
            rPtr_4[6].y += rPtr[10].y;
            
            *(gPtr + 234881024) = rPtr[11];
            rPtr_4[7].x += rPtr[11].x;
            rPtr_4[7].y += rPtr[11].y;
            
            *(gPtr + 268435456) = rPtr[4];
            rPtr_4[8].x += rPtr[4].x;
            rPtr_4[8].y += rPtr[4].y;
            
            *(gPtr + 301989888) = rPtr[5];
            rPtr_4[9].x += rPtr[5].x;
            rPtr_4[9].y += rPtr[5].y;
            
            *(gPtr + 335544320) = rPtr[6];
            rPtr_4[10].x += rPtr[6].x;
            rPtr_4[10].y += rPtr[6].y;
            
            *(gPtr + 369098752) = rPtr[7];
...
#include "../../../TurboFFT_radix_2_template.h"
template<>
__global__ void fft_radix_2<double2, 29, 0, 1, 0>(double2* inputs, double2* outputs, double2* twiddle, double2* checksum_DFT, int BS, int thread_bs) {
    int bid_cnt = 0;
...
#include "../../../TurboFFT_radix_2_template.h"
template<>
__global__ void fft_radix_2<double2, 29, 0, 1, 1>(double2* inputs, double2* outputs, double2* twiddle, double2* checksum_DFT, int BS, int thread_bs) {
    int bid_cnt = 0;
