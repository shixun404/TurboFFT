...
template<>
__global__ void fft_radix_2<float2, 29, 2, 0, 0>(float2* inputs, float2* outputs, float2* twiddle, float2* checksum_DFT, int BS, int thread_bs) {
    int bid_cnt = 0;
    ...
    gPtr += (bx % BS * 536870912);
            ...
            *(gPtr + 117440512) = rPtr[28];
            rPtr_4[7].x += rPtr[28].x;
            rPtr_4[7].y += rPtr[28].y;
            
            *(gPtr + 134217728) = rPtr[2];
            rPtr_4[8].x += rPtr[2].x;
            rPtr_4[8].y += rPtr[2].y;
            
            *(gPtr + 150994944) = rPtr[18];
...
#include "../../../TurboFFT_radix_2_template.h"
template<>
__global__ void fft_radix_2<float2, 29, 2, 1, 0>(float2* inputs, float2* outputs, float2* twiddle, float2* checksum_DFT, int BS, int thread_bs) {
    int bid_cnt = 0;
...
#include "../../../TurboFFT_radix_2_template.h"
template<>
__global__ void fft_radix_2<float2, 29, 2, 1, 1>(float2* inputs, float2* outputs, float2* twiddle, float2* checksum_DFT, int BS, int thread_bs) {
    int bid_cnt = 0;
    ...
    gPtr += (bx % BS * 536870912);
            ...
            *(gPtr + 251658240) = rPtr[30];
            ...
            // rPtr_3[16] = *(gPtr + 268435456);
            // turboFFT_ZADD(rPtr_3[16], rPtr_3[16], rPtr[1] );
            // *(gPtr + 268435456) = rPtr_3[16];
            *(gPtr + 268435456) = rPtr[1];
        
            // rPtr_3[17] = *(gPtr + 285212672);
            // turboFFT_ZADD(rPtr_3[17], rPtr_3[17], rPtr[17] );
            // *(gPtr + 285212672) = rPtr_3[17];
            *(gPtr + 285212672) = rPtr[17];
        
            // rPtr_3[18] = *(gPtr + 301989888);
            // turboFFT_ZADD(rPtr_3[18], rPtr_3[18], rPtr[9] );
            // *(gPtr + 301989888) = rPtr_3[18];
            *(gPtr + 301989888) = rPtr[9];
        
            // rPtr_3[19] = *(gPtr + 318767104);
            // turboFFT_ZADD(rPtr_3[19], rPtr_3[19], rPtr[25] );
            // *(gPtr + 318767104) = rPtr_3[19];
            *(gPtr + 318767104) = rPtr[25];
        
            // rPtr_3[20] = *(gPtr + 335544320);
            // turboFFT_ZADD(rPtr_3[20], rPtr_3[20], rPtr[5] );
            // *(gPtr + 335544320) = rPtr_3[20];
            *(gPtr + 335544320) = rPtr[5];
        
            // rPtr_3[21] = *(gPtr + 352321536);
            // turboFFT_ZADD(rPtr_3[21], rPtr_3[21], rPtr[21] );
            // *(gPtr + 352321536) = rPtr_3[21];
            *(gPtr + 352321536) = rPtr[21];
        
            // rPtr_3[22] = *(gPtr + 369098752);
            // turboFFT_ZADD(rPtr_3[22], rPtr_3[22], rPtr[13] );
            // *(gPtr + 369098752) = rPtr_3[22];
            *(gPtr + 369098752) = rPtr[13];
        
            // rPtr_3[23] = *(gPtr + 385875968);
            // turboFFT_ZADD(rPtr_3[23], rPtr_3[23], rPtr[29] );
            // *(gPtr + 385875968) = rPtr_3[23];
            *(gPtr + 385875968) = rPtr[29];
        
            // rPtr_3[24] = *(gPtr + 402653184);
            // turboFFT_ZADD(rPtr_3[24], rPtr_3[24], rPtr[3] );
            // *(gPtr + 402653184) = rPtr_3[24];
            *(gPtr + 402653184) = rPtr[3];
        
            // rPtr_3[25] = *(gPtr + 419430400);
            // turboFFT_ZADD(rPtr_3[25], rPtr_3[25], rPtr[19] );
            // *(gPtr + 419430400) = rPtr_3[25];
            *(gPtr + 419430400) = rPtr[19];
        
            // rPtr_3[26] = *(gPtr + 436207616);
            // turboFFT_ZADD(rPtr_3[26], rPtr_3[26], rPtr[11] );
            // *(gPtr + 436207616) = rPtr_3[26];
            *(gPtr + 436207616) = rPtr[11];
        
            // rPtr_3[27] = *(gPtr + 452984832);
            // turboFFT_ZADD(rPtr_3[27], rPtr_3[27], rPtr[27] );
            // *(gPtr + 452984832) = rPtr_3[27];
            *(gPtr + 452984832) = rPtr[27];
        
            // rPtr_3[28] = *(gPtr + 469762048);
            // turboFFT_ZADD(rPtr_3[28], rPtr_3[28], rPtr[7] );
            // *(gPtr + 469762048) = rPtr_3[28];
            *(gPtr + 469762048) = rPtr[7];
        
            // rPtr_3[29] = *(gPtr + 486539264);
            // turboFFT_ZADD(rPtr_3[29], rPtr_3[29], rPtr[23] );
            // *(gPtr + 486539264) = rPtr_3[29];
            *(gPtr + 486539264) = rPtr[23];
        
            // rPtr_3[30] = *(gPtr + 503316480);
            // turboFFT_ZADD(rPtr_3[30], rPtr_3[30], rPtr[15] );
            // *(gPtr + 503316480) = rPtr_3[30];
            *(gPtr + 503316480) = rPtr[15];
        
            // rPtr_3[31] = *(gPtr + 520093696);
            // turboFFT_ZADD(rPtr_3[31], rPtr_3[31], rPtr[31] );
            // *(gPtr + 520093696) = rPtr_3[31];
            *(gPtr + 520093696) = rPtr[31];
        }}