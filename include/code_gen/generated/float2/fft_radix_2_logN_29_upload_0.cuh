...
template<>
__global__ void fft_radix_2<float2, 29, 0, 0, 0>(float2* inputs, float2* outputs, float2* twiddle, float2* checksum_DFT, int BS, int thread_bs) {
    int bid_cnt = 0;
    ...
    gPtr += (bx % BS * 536870912);
        ...
        rPtr[1] = *(gPtr + 33554432);
        rPtr_3[1].x += rPtr[1].x;
        rPtr_3[1].y += rPtr[1].y;
        
        rPtr[2] = *(gPtr + 67108864);
        rPtr_3[2].x += rPtr[2].x;
        rPtr_3[2].y += rPtr[2].y;
        
        rPtr[3] = *(gPtr + 100663296);
        rPtr_3[3].x += rPtr[3].x;
        rPtr_3[3].y += rPtr[3].y;
        
        rPtr[4] = *(gPtr + 134217728);
        rPtr_3[4].x += rPtr[4].x;
        rPtr_3[4].y += rPtr[4].y;
        
        rPtr[5] = *(gPtr + 167772160);
        rPtr_3[5].x += rPtr[5].x;
        rPtr_3[5].y += rPtr[5].y;
        
        rPtr[6] = *(gPtr + 201326592);
        rPtr_3[6].x += rPtr[6].x;
        rPtr_3[6].y += rPtr[6].y;
        
        rPtr[7] = *(gPtr + 234881024);
        rPtr_3[7].x += rPtr[7].x;
        rPtr_3[7].y += rPtr[7].y;
        
        rPtr[8] = *(gPtr + 268435456);
        rPtr_3[8].x += rPtr[8].x;
        rPtr_3[8].y += rPtr[8].y;
        
        rPtr[9] = *(gPtr + 301989888);
        rPtr_3[9].x += rPtr[9].x;
        rPtr_3[9].y += rPtr[9].y;
        
        rPtr[10] = *(gPtr + 335544320);
        rPtr_3[10].x += rPtr[10].x;
        rPtr_3[10].y += rPtr[10].y;
        
        rPtr[11] = *(gPtr + 369098752);
        rPtr_3[11].x += rPtr[11].x;
        rPtr_3[11].y += rPtr[11].y;
        
        rPtr[12] = *(gPtr + 402653184);
        rPtr_3[12].x += rPtr[12].x;
        rPtr_3[12].y += rPtr[12].y;
        
        rPtr[13] = *(gPtr + 436207616);
        rPtr_3[13].x += rPtr[13].x;
        rPtr_3[13].y += rPtr[13].y;
        
        rPtr[14] = *(gPtr + 469762048);
        rPtr_3[14].x += rPtr[14].x;
        rPtr_3[14].y += rPtr[14].y;
        
        rPtr[15] = *(gPtr + 503316480);
    ...
    global_k += tx / 16;
        ...
        delta_angle.x = __cosf(global_j *  -3.7450703871400037e-07f);
        delta_angle.y = __sinf(global_j *  -3.7450703871400037e-07f);
        angle.x = __cosf( global_j * global_k * -1.1703344634137277e-08f);
        angle.y = __sinf( global_j * global_k * -1.1703344634137277e-08f);
        ...
        turboFFT_ZMUL(angle, tmp, delta_angle);
            ...
            *(gPtr + 100663296) = rPtr[3];
            rPtr_4[3].x += rPtr[3].x;
            rPtr_4[3].y += rPtr[3].y;
            
            *(gPtr + 134217728) = rPtr[4];
            rPtr_4[4].x += rPtr[4].x;
            rPtr_4[4].y += rPtr[4].y;
...
#include "../../../TurboFFT_radix_2_template.h"
template<>
__global__ void fft_radix_2<float2, 29, 0, 1, 0>(float2* inputs, float2* outputs, float2* twiddle, float2* checksum_DFT, int BS, int thread_bs) {
    int bid_cnt = 0;
    ...
    global_k += tx / 16;
        ...
        turboFFT_ZMUL(tmp, rPtr[1],r[(32 + tx / 16) % 3])
        tmp_1.y -= (tmp.x + tmp.y);
        tmp_3.y -= (tmp.y + tmp.x) * bid_cnt;
        // turboFFT_ZMUL_NACC(tmp_1,  rPtr[1], r[(32 + tx / 16) % 3])
        // turboFFT_ZMUL_NACC(tmp_3,  rPtr[1], r[(32 + tx / 16) % 3])
        ...
        turboFFT_ZMUL(tmp, rPtr[3],r[(96 + tx / 16) % 3])
        tmp_1.y -= (tmp.x + tmp.y);
        tmp_3.y -= (tmp.y + tmp.x) * bid_cnt;
        // turboFFT_ZMUL_NACC(tmp_1,  rPtr[3], r[(96 + tx / 16) % 3])
        // turboFFT_ZMUL_NACC(tmp_3,  rPtr[3], r[(96 + tx / 16) % 3])
        ...
        turboFFT_ZMUL(tmp, rPtr[4],r[(128 + tx / 16) % 3])
        tmp_1.y -= (tmp.x + tmp.y);
        tmp_3.y -= (tmp.y + tmp.x) * bid_cnt;
        // turboFFT_ZMUL_NACC(tmp_1,  rPtr[4], r[(128 + tx / 16) % 3])
        // turboFFT_ZMUL_NACC(tmp_3,  rPtr[4], r[(128 + tx / 16) % 3])
        ...
        turboFFT_ZMUL(tmp, rPtr[6],r[(192 + tx / 16) % 3])
        tmp_1.y -= (tmp.x + tmp.y);
        tmp_3.y -= (tmp.y + tmp.x) * bid_cnt;
        // turboFFT_ZMUL_NACC(tmp_1,  rPtr[6], r[(192 + tx / 16) % 3])
        // turboFFT_ZMUL_NACC(tmp_3,  rPtr[6], r[(192 + tx / 16) % 3])
        ...
        turboFFT_ZMUL(tmp, rPtr[8],r[(256 + tx / 16) % 3])
        tmp_1.y -= (tmp.x + tmp.y);
        tmp_3.y -= (tmp.y + tmp.x) * bid_cnt;
        // turboFFT_ZMUL_NACC(tmp_1,  rPtr[8], r[(256 + tx / 16) % 3])
        // turboFFT_ZMUL_NACC(tmp_3,  rPtr[8], r[(256 + tx / 16) % 3])
        ...
        turboFFT_ZMUL(tmp, rPtr[9],r[(288 + tx / 16) % 3])
        tmp_1.y -= (tmp.x + tmp.y);
        tmp_3.y -= (tmp.y + tmp.x) * bid_cnt;
        // turboFFT_ZMUL_NACC(tmp_1,  rPtr[9], r[(288 + tx / 16) % 3])
        // turboFFT_ZMUL_NACC(tmp_3,  rPtr[9], r[(288 + tx / 16) % 3])
        ...
        turboFFT_ZMUL(tmp, rPtr[10],r[(320 + tx / 16) % 3])
        tmp_1.y -= (tmp.x + tmp.y);
        tmp_3.y -= (tmp.y + tmp.x) * bid_cnt;
        // turboFFT_ZMUL_NACC(tmp_1,  rPtr[10], r[(320 + tx / 16) % 3])
        // turboFFT_ZMUL_NACC(tmp_3,  rPtr[10], r[(320 + tx / 16) % 3])
        ...
        turboFFT_ZMUL(tmp, rPtr[11],r[(352 + tx / 16) % 3])
        tmp_1.y -= (tmp.x + tmp.y);
        tmp_3.y -= (tmp.y + tmp.x) * bid_cnt;
        // turboFFT_ZMUL_NACC(tmp_1,  rPtr[11], r[(352 + tx / 16) % 3])
        // turboFFT_ZMUL_NACC(tmp_3,  rPtr[11], r[(352 + tx / 16) % 3])
        ...
        turboFFT_ZMUL(tmp, rPtr[12],r[(384 + tx / 16) % 3])
        tmp_1.y -= (tmp.x + tmp.y);
        tmp_3.y -= (tmp.y + tmp.x) * bid_cnt;
        // turboFFT_ZMUL_NACC(tmp_1,  rPtr[12], r[(384 + tx / 16) % 3])
        // turboFFT_ZMUL_NACC(tmp_3,  rPtr[12], r[(384 + tx / 16) % 3])
        ...
        turboFFT_ZMUL(tmp, rPtr[13],r[(416 + tx / 16) % 3])
        tmp_1.y -= (tmp.x + tmp.y);
        tmp_3.y -= (tmp.y + tmp.x) * bid_cnt;
        // turboFFT_ZMUL_NACC(tmp_1,  rPtr[13], r[(416 + tx / 16) % 3])
        // turboFFT_ZMUL_NACC(tmp_3,  rPtr[13], r[(416 + tx / 16) % 3])
        ...
        turboFFT_ZMUL(tmp, rPtr[14],r[(448 + tx / 16) % 3])
        tmp_1.y -= (tmp.x + tmp.y);
        tmp_3.y -= (tmp.y + tmp.x) * bid_cnt;
        // turboFFT_ZMUL_NACC(tmp_1,  rPtr[14], r[(448 + tx / 16) % 3])
        // turboFFT_ZMUL_NACC(tmp_3,  rPtr[14], r[(448 + tx / 16) % 3])
        ...
        turboFFT_ZMUL(tmp, rPtr[15],r[(480 + tx / 16) % 3])
        tmp_1.y -= (tmp.x + tmp.y);
        tmp_3.y -= (tmp.y + tmp.x) * bid_cnt;
        // turboFFT_ZMUL_NACC(tmp_1,  rPtr[15], r[(480 + tx / 16) % 3])
        // turboFFT_ZMUL_NACC(tmp_3,  rPtr[15], r[(480 + tx / 16) % 3])
        ...
        // 1's vector
        // tmp.x = (tx / 16 == 0) ? (rPtr_3[0].y + rPtr_3[0].x) * 512: 0;
        // tmp.y = (tx / 16 == 0) ? (abs(rPtr_3[0].y) + abs(rPtr_3[0].x)) * 512: 0;
        tmp = tmp_1;
        tmp_1.y += tmp.x;
...
#include "../../../TurboFFT_radix_2_template.h"
template<>
__global__ void fft_radix_2<float2, 29, 0, 1, 1>(float2* inputs, float2* outputs, float2* twiddle, float2* checksum_DFT, int BS, int thread_bs) {
    int bid_cnt = 0;
    ...
    global_k += tx / 16;
        ...
        turboFFT_ZMUL(angle, tmp, delta_angle);
            ...
            *(gPtr + 0) = rPtr[0];
            ...
            // rPtr_3[1] = *(gPtr + 33554432);
            // turboFFT_ZADD(rPtr_3[1], rPtr_3[1], rPtr[1] );
            // *(gPtr + 33554432) = rPtr_3[1];
            *(gPtr + 33554432) = rPtr[1];
        
            // rPtr_3[2] = *(gPtr + 67108864);
            // turboFFT_ZADD(rPtr_3[2], rPtr_3[2], rPtr[2] );
            // *(gPtr + 67108864) = rPtr_3[2];
            *(gPtr + 67108864) = rPtr[2];
        
            // rPtr_3[3] = *(gPtr + 100663296);
            // turboFFT_ZADD(rPtr_3[3], rPtr_3[3], rPtr[3] );
            // *(gPtr + 100663296) = rPtr_3[3];
            *(gPtr + 100663296) = rPtr[3];
        
            // rPtr_3[4] = *(gPtr + 134217728);
            // turboFFT_ZADD(rPtr_3[4], rPtr_3[4], rPtr[4] );
            // *(gPtr + 134217728) = rPtr_3[4];
            *(gPtr + 134217728) = rPtr[4];
        
            // rPtr_3[5] = *(gPtr + 167772160);
            // turboFFT_ZADD(rPtr_3[5], rPtr_3[5], rPtr[5] );
            // *(gPtr + 167772160) = rPtr_3[5];
            *(gPtr + 167772160) = rPtr[5];
        
            // rPtr_3[6] = *(gPtr + 201326592);
            // turboFFT_ZADD(rPtr_3[6], rPtr_3[6], rPtr[6] );
            // *(gPtr + 201326592) = rPtr_3[6];
            *(gPtr + 201326592) = rPtr[6];
        
            // rPtr_3[7] = *(gPtr + 234881024);
            // turboFFT_ZADD(rPtr_3[7], rPtr_3[7], rPtr[7] );
            // *(gPtr + 234881024) = rPtr_3[7];
            *(gPtr + 234881024) = rPtr[7];
        
            // rPtr_3[8] = *(gPtr + 268435456);
            // turboFFT_ZADD(rPtr_3[8], rPtr_3[8], rPtr[8] );
            // *(gPtr + 268435456) = rPtr_3[8];
            *(gPtr + 268435456) = rPtr[8];
        
            // rPtr_3[9] = *(gPtr + 301989888);
            // turboFFT_ZADD(rPtr_3[9], rPtr_3[9], rPtr[9] );
            // *(gPtr + 301989888) = rPtr_3[9];
            *(gPtr + 301989888) = rPtr[9];
        
            // rPtr_3[10] = *(gPtr + 335544320);
            // turboFFT_ZADD(rPtr_3[10], rPtr_3[10], rPtr[10] );
            // *(gPtr + 335544320) = rPtr_3[10];
            *(gPtr + 335544320) = rPtr[10];
        
            // rPtr_3[11] = *(gPtr + 369098752);
            // turboFFT_ZADD(rPtr_3[11], rPtr_3[11], rPtr[11] );
            // *(gPtr + 369098752) = rPtr_3[11];
            *(gPtr + 369098752) = rPtr[11];
        
            // rPtr_3[12] = *(gPtr + 402653184);
            // turboFFT_ZADD(rPtr_3[12], rPtr_3[12], rPtr[12] );
            // *(gPtr + 402653184) = rPtr_3[12];
            *(gPtr + 402653184) = rPtr[12];
        
            // rPtr_3[13] = *(gPtr + 436207616);
            // turboFFT_ZADD(rPtr_3[13], rPtr_3[13], rPtr[13] );
            // *(gPtr + 436207616) = rPtr_3[13];
            *(gPtr + 436207616) = rPtr[13];
        
            // rPtr_3[14] = *(gPtr + 469762048);
            // turboFFT_ZADD(rPtr_3[14], rPtr_3[14], rPtr[14] );
            // *(gPtr + 469762048) = rPtr_3[14];
            *(gPtr + 469762048) = rPtr[14];
        
            // rPtr_3[15] = *(gPtr + 503316480);
            // turboFFT_ZADD(rPtr_3[15], rPtr_3[15], rPtr[15] );
            // *(gPtr + 503316480) = rPtr_3[15];
            *(gPtr + 503316480) = rPtr[15];
        }}