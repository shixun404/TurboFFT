...
template<>
__global__ void fft_radix_2<float2, 28, 1, 0, 0>(float2* inputs, float2* outputs, float2* twiddle, float2* checksum_DFT, int BS, int thread_bs) {
    int bid_cnt = 0;
    ...
    global_k += tx / 16;
        ...
        delta_angle.x = __cosf(global_j *  -0.0003834952076431364f);
        delta_angle.y = __sinf(global_j *  -0.0003834952076431364f);
        angle.x = __cosf( global_j * global_k * -1.1984224905356572e-05f);
        angle.y = __sinf( global_j * global_k * -1.1984224905356572e-05f);
...
#include "../../../TurboFFT_radix_2_template.h"
template<>
__global__ void fft_radix_2<float2, 28, 1, 1, 0>(float2* inputs, float2* outputs, float2* twiddle, float2* checksum_DFT, int BS, int thread_bs) {
    int bid_cnt = 0;
...
#include "../../../TurboFFT_radix_2_template.h"
template<>
__global__ void fft_radix_2<float2, 28, 1, 1, 1>(float2* inputs, float2* outputs, float2* twiddle, float2* checksum_DFT, int BS, int thread_bs) {
    int bid_cnt = 0;
