...
template<>
__global__ void fft_radix_2<float2, 26, 0, 0, 0>(float2* inputs, float2* outputs, float2* twiddle, float2* checksum_DFT, int BS, int thread_bs) {
    int bid_cnt = 0;
    ...
    for(bid = (blockIdx.x / tb_gap) * tb_gap * thread_bs + blockIdx.x % tb_gap;
                bid_cnt < thread_bs && bid < (67108864 * BS + 8192 - 1) / 8192; bid += delta_bid)
    {
    bid_cnt += 1;
    ...
    gPtr += (bx % BS * 67108864);
        ...
        rPtr[3] = *(gPtr + 12582912);
        rPtr_3[3].x += rPtr[3].x;
        rPtr_3[3].y += rPtr[3].y;
        
        rPtr[4] = *(gPtr + 16777216);
        rPtr_3[4].x += rPtr[4].x;
        rPtr_3[4].y += rPtr[4].y;
        
        rPtr[5] = *(gPtr + 20971520);
        rPtr_3[5].x += rPtr[5].x;
        rPtr_3[5].y += rPtr[5].y;
        
        rPtr[6] = *(gPtr + 25165824);
        rPtr_3[6].x += rPtr[6].x;
        rPtr_3[6].y += rPtr[6].y;
        
        rPtr[7] = *(gPtr + 29360128);
        rPtr_3[7].x += rPtr[7].x;
        rPtr_3[7].y += rPtr[7].y;
        
        rPtr[8] = *(gPtr + 33554432);
        rPtr_3[8].x += rPtr[8].x;
        rPtr_3[8].y += rPtr[8].y;
        
        rPtr[9] = *(gPtr + 37748736);
        rPtr_3[9].x += rPtr[9].x;
        rPtr_3[9].y += rPtr[9].y;
        
        rPtr[10] = *(gPtr + 41943040);
        rPtr_3[10].x += rPtr[10].x;
        rPtr_3[10].y += rPtr[10].y;
        
        rPtr[11] = *(gPtr + 46137344);
        rPtr_3[11].x += rPtr[11].x;
        rPtr_3[11].y += rPtr[11].y;
        
        rPtr[12] = *(gPtr + 50331648);
        rPtr_3[12].x += rPtr[12].x;
        rPtr_3[12].y += rPtr[12].y;
        
        rPtr[13] = *(gPtr + 54525952);
        rPtr_3[13].x += rPtr[13].x;
        rPtr_3[13].y += rPtr[13].y;
        
        rPtr[14] = *(gPtr + 58720256);
        rPtr_3[14].x += rPtr[14].x;
        rPtr_3[14].y += rPtr[14].y;
        
        rPtr[15] = *(gPtr + 62914560);
    ...
    global_k += tx / 16;
        ...
        delta_angle.x = __cosf(global_j *  -2.996056309712003e-06f);
        delta_angle.y = __sinf(global_j *  -2.996056309712003e-06f);
        angle.x = __cosf( global_j * global_k * -9.362675707309822e-08f);
        angle.y = __sinf( global_j * global_k * -9.362675707309822e-08f);
        ...
        turboFFT_ZMUL(angle, tmp, delta_angle);
            ...
            *(gPtr + 12582912) = rPtr[3];
            rPtr_4[3].x += rPtr[3].x;
            rPtr_4[3].y += rPtr[3].y;
            
            *(gPtr + 16777216) = rPtr[4];
            rPtr_4[4].x += rPtr[4].x;
            rPtr_4[4].y += rPtr[4].y;
            
            *(gPtr + 20971520) = rPtr[5];
            rPtr_4[5].x += rPtr[5].x;
            rPtr_4[5].y += rPtr[5].y;
            
            *(gPtr + 25165824) = rPtr[6];
            rPtr_4[6].x += rPtr[6].x;
            rPtr_4[6].y += rPtr[6].y;
            
            *(gPtr + 29360128) = rPtr[7];
            rPtr_4[7].x += rPtr[7].x;
            rPtr_4[7].y += rPtr[7].y;
            
            *(gPtr + 33554432) = rPtr[8];
            rPtr_4[8].x += rPtr[8].x;
            rPtr_4[8].y += rPtr[8].y;
            
            *(gPtr + 37748736) = rPtr[9];
            rPtr_4[9].x += rPtr[9].x;
            rPtr_4[9].y += rPtr[9].y;
            
            *(gPtr + 41943040) = rPtr[10];
            rPtr_4[10].x += rPtr[10].x;
            rPtr_4[10].y += rPtr[10].y;
            
            *(gPtr + 46137344) = rPtr[11];
...
#include "../../../TurboFFT_radix_2_template.h"
template<>
__global__ void fft_radix_2<float2, 26, 0, 1, 0>(float2* inputs, float2* outputs, float2* twiddle, float2* checksum_DFT, int BS, int thread_bs) {
    int bid_cnt = 0;
...
#include "../../../TurboFFT_radix_2_template.h"
template<>
__global__ void fft_radix_2<float2, 26, 0, 1, 1>(float2* inputs, float2* outputs, float2* twiddle, float2* checksum_DFT, int BS, int thread_bs) {
    int bid_cnt = 0;
    ...
    global_k += tx / 16;
        ...
        turboFFT_ZMUL(angle, tmp, delta_angle);
            ...
            *(gPtr + 0) = rPtr[0];
            ...
            // rPtr_3[1] = *(gPtr + 4194304);
            // turboFFT_ZADD(rPtr_3[1], rPtr_3[1], rPtr[1] );
            // *(gPtr + 4194304) = rPtr_3[1];
            *(gPtr + 4194304) = rPtr[1];
        
            // rPtr_3[2] = *(gPtr + 8388608);
            // turboFFT_ZADD(rPtr_3[2], rPtr_3[2], rPtr[2] );
            // *(gPtr + 8388608) = rPtr_3[2];
            *(gPtr + 8388608) = rPtr[2];
        
            // rPtr_3[3] = *(gPtr + 12582912);
            // turboFFT_ZADD(rPtr_3[3], rPtr_3[3], rPtr[3] );
            // *(gPtr + 12582912) = rPtr_3[3];
            *(gPtr + 12582912) = rPtr[3];
        
            // rPtr_3[4] = *(gPtr + 16777216);
            // turboFFT_ZADD(rPtr_3[4], rPtr_3[4], rPtr[4] );
            // *(gPtr + 16777216) = rPtr_3[4];
            *(gPtr + 16777216) = rPtr[4];
        
            // rPtr_3[5] = *(gPtr + 20971520);
            // turboFFT_ZADD(rPtr_3[5], rPtr_3[5], rPtr[5] );
            // *(gPtr + 20971520) = rPtr_3[5];
            *(gPtr + 20971520) = rPtr[5];
        
            // rPtr_3[6] = *(gPtr + 25165824);
            // turboFFT_ZADD(rPtr_3[6], rPtr_3[6], rPtr[6] );
            // *(gPtr + 25165824) = rPtr_3[6];
            *(gPtr + 25165824) = rPtr[6];
        
            // rPtr_3[7] = *(gPtr + 29360128);
            // turboFFT_ZADD(rPtr_3[7], rPtr_3[7], rPtr[7] );
            // *(gPtr + 29360128) = rPtr_3[7];
            *(gPtr + 29360128) = rPtr[7];
        
            // rPtr_3[8] = *(gPtr + 33554432);
            // turboFFT_ZADD(rPtr_3[8], rPtr_3[8], rPtr[8] );
            // *(gPtr + 33554432) = rPtr_3[8];
            *(gPtr + 33554432) = rPtr[8];
        
            // rPtr_3[9] = *(gPtr + 37748736);
            // turboFFT_ZADD(rPtr_3[9], rPtr_3[9], rPtr[9] );
            // *(gPtr + 37748736) = rPtr_3[9];
            *(gPtr + 37748736) = rPtr[9];
        
            // rPtr_3[10] = *(gPtr + 41943040);
            // turboFFT_ZADD(rPtr_3[10], rPtr_3[10], rPtr[10] );
            // *(gPtr + 41943040) = rPtr_3[10];
            *(gPtr + 41943040) = rPtr[10];
        
            // rPtr_3[11] = *(gPtr + 46137344);
            // turboFFT_ZADD(rPtr_3[11], rPtr_3[11], rPtr[11] );
            // *(gPtr + 46137344) = rPtr_3[11];
            *(gPtr + 46137344) = rPtr[11];
        
            // rPtr_3[12] = *(gPtr + 50331648);
            // turboFFT_ZADD(rPtr_3[12], rPtr_3[12], rPtr[12] );
            // *(gPtr + 50331648) = rPtr_3[12];
            *(gPtr + 50331648) = rPtr[12];
        
            // rPtr_3[13] = *(gPtr + 54525952);
            // turboFFT_ZADD(rPtr_3[13], rPtr_3[13], rPtr[13] );
            // *(gPtr + 54525952) = rPtr_3[13];
            *(gPtr + 54525952) = rPtr[13];
        
            // rPtr_3[14] = *(gPtr + 58720256);
            // turboFFT_ZADD(rPtr_3[14], rPtr_3[14], rPtr[14] );
            // *(gPtr + 58720256) = rPtr_3[14];
            *(gPtr + 58720256) = rPtr[14];
        
            // rPtr_3[15] = *(gPtr + 62914560);
            // turboFFT_ZADD(rPtr_3[15], rPtr_3[15], rPtr[15] );
            // *(gPtr + 62914560) = rPtr_3[15];
            *(gPtr + 62914560) = rPtr[15];
        }}