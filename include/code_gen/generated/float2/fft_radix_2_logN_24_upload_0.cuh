...
template<>
__global__ void fft_radix_2<float2, 24, 0, 0, 0>(float2* inputs, float2* outputs, float2* twiddle, float2* checksum_DFT, int BS, int thread_bs) {
    int bid_cnt = 0;
    ...
    for(bid = (blockIdx.x / tb_gap) * tb_gap * thread_bs + blockIdx.x % tb_gap;
                bid_cnt < thread_bs && bid < (16777216 * BS + 2048 - 1) / 2048; bid += delta_bid)
    {
    bid_cnt += 1;
    ...
    global_k += tx / 8;
        ...
        delta_angle = twiddle[16777215 + global_j * (16)];
        angle = twiddle[16777215 + global_j * global_k];
        ...
        turboFFT_ZMUL(angle, tmp, delta_angle);
            ...
            *(gPtr + 10485760) = rPtr[5];
            rPtr_4[10].x += rPtr[5].x;
            rPtr_4[10].y += rPtr[5].y;
            
            *(gPtr + 11534336) = rPtr[13];
...
#include "../../../TurboFFT_radix_2_template.h"
template<>
__global__ void fft_radix_2<float2, 24, 0, 1, 0>(float2* inputs, float2* outputs, float2* twiddle, float2* checksum_DFT, int BS, int thread_bs) {
    int bid_cnt = 0;
    ...
    rPtr_2[1] = *(checksum_DFT + 256 - 2 + tx + 128);
    ...
    global_k += tx / 8;
        ...
        turboFFT_ZMUL(tmp, rPtr[8],r[(16 + tx / 8) % 3])
        tmp_1.y -= (tmp.x + tmp.y);
        tmp_3.y -= (tmp.y + tmp.x) * bid_cnt;
        // turboFFT_ZMUL_NACC(tmp_1,  rPtr[8], r[(16 + tx / 8) % 3])
        // turboFFT_ZMUL_NACC(tmp_3,  rPtr[8], r[(16 + tx / 8) % 3])
        ...
        turboFFT_ZMUL(tmp, rPtr[4],r[(32 + tx / 8) % 3])
        tmp_1.y -= (tmp.x + tmp.y);
        tmp_3.y -= (tmp.y + tmp.x) * bid_cnt;
        // turboFFT_ZMUL_NACC(tmp_1,  rPtr[4], r[(32 + tx / 8) % 3])
        // turboFFT_ZMUL_NACC(tmp_3,  rPtr[4], r[(32 + tx / 8) % 3])
        ...
        turboFFT_ZMUL(tmp, rPtr[12],r[(48 + tx / 8) % 3])
        tmp_1.y -= (tmp.x + tmp.y);
        tmp_3.y -= (tmp.y + tmp.x) * bid_cnt;
        // turboFFT_ZMUL_NACC(tmp_1,  rPtr[12], r[(48 + tx / 8) % 3])
        // turboFFT_ZMUL_NACC(tmp_3,  rPtr[12], r[(48 + tx / 8) % 3])
        ...
        turboFFT_ZMUL(tmp, rPtr[10],r[(80 + tx / 8) % 3])
        tmp_1.y -= (tmp.x + tmp.y);
        tmp_3.y -= (tmp.y + tmp.x) * bid_cnt;
        // turboFFT_ZMUL_NACC(tmp_1,  rPtr[10], r[(80 + tx / 8) % 3])
        // turboFFT_ZMUL_NACC(tmp_3,  rPtr[10], r[(80 + tx / 8) % 3])
        ...
        turboFFT_ZMUL(tmp, rPtr[6],r[(96 + tx / 8) % 3])
        tmp_1.y -= (tmp.x + tmp.y);
        tmp_3.y -= (tmp.y + tmp.x) * bid_cnt;
        // turboFFT_ZMUL_NACC(tmp_1,  rPtr[6], r[(96 + tx / 8) % 3])
        // turboFFT_ZMUL_NACC(tmp_3,  rPtr[6], r[(96 + tx / 8) % 3])
        ...
        turboFFT_ZMUL(tmp, rPtr[14],r[(112 + tx / 8) % 3])
        tmp_1.y -= (tmp.x + tmp.y);
        tmp_3.y -= (tmp.y + tmp.x) * bid_cnt;
        // turboFFT_ZMUL_NACC(tmp_1,  rPtr[14], r[(112 + tx / 8) % 3])
        // turboFFT_ZMUL_NACC(tmp_3,  rPtr[14], r[(112 + tx / 8) % 3])
        ...
        turboFFT_ZMUL(tmp, rPtr[1],r[(128 + tx / 8) % 3])
        tmp_1.y -= (tmp.x + tmp.y);
        tmp_3.y -= (tmp.y + tmp.x) * bid_cnt;
        // turboFFT_ZMUL_NACC(tmp_1,  rPtr[1], r[(128 + tx / 8) % 3])
        // turboFFT_ZMUL_NACC(tmp_3,  rPtr[1], r[(128 + tx / 8) % 3])
        ...
        turboFFT_ZMUL(tmp, rPtr[9],r[(144 + tx / 8) % 3])
        tmp_1.y -= (tmp.x + tmp.y);
        tmp_3.y -= (tmp.y + tmp.x) * bid_cnt;
        // turboFFT_ZMUL_NACC(tmp_1,  rPtr[9], r[(144 + tx / 8) % 3])
        // turboFFT_ZMUL_NACC(tmp_3,  rPtr[9], r[(144 + tx / 8) % 3])
        ...
        turboFFT_ZMUL(tmp, rPtr[13],r[(176 + tx / 8) % 3])
        tmp_1.y -= (tmp.x + tmp.y);
        tmp_3.y -= (tmp.y + tmp.x) * bid_cnt;
        // turboFFT_ZMUL_NACC(tmp_1,  rPtr[13], r[(176 + tx / 8) % 3])
        // turboFFT_ZMUL_NACC(tmp_3,  rPtr[13], r[(176 + tx / 8) % 3])
        ...
        turboFFT_ZMUL(tmp, rPtr[11],r[(208 + tx / 8) % 3])
        tmp_1.y -= (tmp.x + tmp.y);
        tmp_3.y -= (tmp.y + tmp.x) * bid_cnt;
        // turboFFT_ZMUL_NACC(tmp_1,  rPtr[11], r[(208 + tx / 8) % 3])
        // turboFFT_ZMUL_NACC(tmp_3,  rPtr[11], r[(208 + tx / 8) % 3])
        ...
        turboFFT_ZMUL(tmp, rPtr[15],r[(240 + tx / 8) % 3])
        tmp_1.y -= (tmp.x + tmp.y);
        tmp_3.y -= (tmp.y + tmp.x) * bid_cnt;
        // turboFFT_ZMUL_NACC(tmp_1,  rPtr[15], r[(240 + tx / 8) % 3])
        // turboFFT_ZMUL_NACC(tmp_3,  rPtr[15], r[(240 + tx / 8) % 3])
...
#include "../../../TurboFFT_radix_2_template.h"
template<>
__global__ void fft_radix_2<float2, 24, 0, 1, 1>(float2* inputs, float2* outputs, float2* twiddle, float2* checksum_DFT, int BS, int thread_bs) {
    int bid_cnt = 0;
    ...
    global_k += tx / 8;
        ...
        turboFFT_ZMUL(angle, tmp, delta_angle);
            ...
            *(gPtr + 0) = rPtr[0];
            ...
            // rPtr_3[1] = *(gPtr + 1048576);
            // turboFFT_ZADD(rPtr_3[1], rPtr_3[1], rPtr[8] );
            // *(gPtr + 1048576) = rPtr_3[1];
            *(gPtr + 1048576) = rPtr[8];
        
            // rPtr_3[2] = *(gPtr + 2097152);
            // turboFFT_ZADD(rPtr_3[2], rPtr_3[2], rPtr[4] );
            // *(gPtr + 2097152) = rPtr_3[2];
            *(gPtr + 2097152) = rPtr[4];
        
            // rPtr_3[3] = *(gPtr + 3145728);
            // turboFFT_ZADD(rPtr_3[3], rPtr_3[3], rPtr[12] );
            // *(gPtr + 3145728) = rPtr_3[3];
            *(gPtr + 3145728) = rPtr[12];
        
            // rPtr_3[4] = *(gPtr + 4194304);
            // turboFFT_ZADD(rPtr_3[4], rPtr_3[4], rPtr[2] );
            // *(gPtr + 4194304) = rPtr_3[4];
            *(gPtr + 4194304) = rPtr[2];
        
            // rPtr_3[5] = *(gPtr + 5242880);
            // turboFFT_ZADD(rPtr_3[5], rPtr_3[5], rPtr[10] );
            // *(gPtr + 5242880) = rPtr_3[5];
            *(gPtr + 5242880) = rPtr[10];
        
            // rPtr_3[6] = *(gPtr + 6291456);
            // turboFFT_ZADD(rPtr_3[6], rPtr_3[6], rPtr[6] );
            // *(gPtr + 6291456) = rPtr_3[6];
            *(gPtr + 6291456) = rPtr[6];
        
            // rPtr_3[7] = *(gPtr + 7340032);
            // turboFFT_ZADD(rPtr_3[7], rPtr_3[7], rPtr[14] );
            // *(gPtr + 7340032) = rPtr_3[7];
            *(gPtr + 7340032) = rPtr[14];
        
            // rPtr_3[8] = *(gPtr + 8388608);
            // turboFFT_ZADD(rPtr_3[8], rPtr_3[8], rPtr[1] );
            // *(gPtr + 8388608) = rPtr_3[8];
            *(gPtr + 8388608) = rPtr[1];
        
            // rPtr_3[9] = *(gPtr + 9437184);
            // turboFFT_ZADD(rPtr_3[9], rPtr_3[9], rPtr[9] );
            // *(gPtr + 9437184) = rPtr_3[9];
            *(gPtr + 9437184) = rPtr[9];
        
            // rPtr_3[10] = *(gPtr + 10485760);
            // turboFFT_ZADD(rPtr_3[10], rPtr_3[10], rPtr[5] );
            // *(gPtr + 10485760) = rPtr_3[10];
            *(gPtr + 10485760) = rPtr[5];
        
            // rPtr_3[11] = *(gPtr + 11534336);
            // turboFFT_ZADD(rPtr_3[11], rPtr_3[11], rPtr[13] );
            // *(gPtr + 11534336) = rPtr_3[11];
            *(gPtr + 11534336) = rPtr[13];
        
            // rPtr_3[12] = *(gPtr + 12582912);
            // turboFFT_ZADD(rPtr_3[12], rPtr_3[12], rPtr[3] );
            // *(gPtr + 12582912) = rPtr_3[12];
            *(gPtr + 12582912) = rPtr[3];
        
            // rPtr_3[13] = *(gPtr + 13631488);
            // turboFFT_ZADD(rPtr_3[13], rPtr_3[13], rPtr[11] );
            // *(gPtr + 13631488) = rPtr_3[13];
            *(gPtr + 13631488) = rPtr[11];
        
            // rPtr_3[14] = *(gPtr + 14680064);
            // turboFFT_ZADD(rPtr_3[14], rPtr_3[14], rPtr[7] );
            // *(gPtr + 14680064) = rPtr_3[14];
            *(gPtr + 14680064) = rPtr[7];
        
            // rPtr_3[15] = *(gPtr + 15728640);
            // turboFFT_ZADD(rPtr_3[15], rPtr_3[15], rPtr[15] );
            // *(gPtr + 15728640) = rPtr_3[15];
            *(gPtr + 15728640) = rPtr[15];
        }}