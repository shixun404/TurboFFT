...
__global__ void fft_radix_2<float2, 24, 0, 0, 0>(float2* inputs, float2* outputs, float2* twiddle, float2* checksum_DFT, int BS, int thread_bs) {
    ...
    gPtr += (bx % BS * 16777216);
        ...
        rPtr[5] = *(gPtr + 10485760);
        rPtr_3[5].x += rPtr[5].x;
        rPtr_3[5].y += rPtr[5].y;
        
        rPtr[6] = *(gPtr + 12582912);
        rPtr_3[6].x += rPtr[6].x;
        rPtr_3[6].y += rPtr[6].y;
        
        rPtr[7] = *(gPtr + 14680064);
        rPtr_3[7].x += rPtr[7].x;
        rPtr_3[7].y += rPtr[7].y;
    ...
    global_k += tx / 8;
        ...
        delta_angle.x = __cosf(global_j *  -2.3968450477696024e-05f);
        delta_angle.y = __sinf(global_j *  -2.3968450477696024e-05f);
        angle.x = __cosf( global_j * global_k * -3.7450702829239286e-07f);
        angle.y = __sinf( global_j * global_k * -3.7450702829239286e-07f);
...
__global__ void fft_radix_2<float2, 24, 0, 1, 0>(float2* inputs, float2* outputs, float2* twiddle, float2* checksum_DFT, int BS, int thread_bs) {
    ...
    global_k += tx / 8;
        ...
        turboFFT_ZMUL(tmp, rPtr[1],r[(256 + tx / 8) % 3])
        tmp_1.y -= (tmp.x + tmp.y);
        tmp_3.y -= (tmp.y + tmp.x) * bid_cnt;
        // turboFFT_ZMUL_NACC(tmp_1,  rPtr[1], r[(256 + tx / 8) % 3])
        // turboFFT_ZMUL_NACC(tmp_3,  rPtr[1], r[(256 + tx / 8) % 3])
        ...
        turboFFT_ZMUL(tmp, rPtr[5],r[(320 + tx / 8) % 3])
        tmp_1.y -= (tmp.x + tmp.y);
        tmp_3.y -= (tmp.y + tmp.x) * bid_cnt;
        // turboFFT_ZMUL_NACC(tmp_1,  rPtr[5], r[(320 + tx / 8) % 3])
        // turboFFT_ZMUL_NACC(tmp_3,  rPtr[5], r[(320 + tx / 8) % 3])
        ...
        turboFFT_ZMUL(tmp, rPtr[3],r[(384 + tx / 8) % 3])
        tmp_1.y -= (tmp.x + tmp.y);
        tmp_3.y -= (tmp.y + tmp.x) * bid_cnt;
        // turboFFT_ZMUL_NACC(tmp_1,  rPtr[3], r[(384 + tx / 8) % 3])
        // turboFFT_ZMUL_NACC(tmp_3,  rPtr[3], r[(384 + tx / 8) % 3])
        ...
        turboFFT_ZMUL(tmp, rPtr[7],r[(448 + tx / 8) % 3])
        tmp_1.y -= (tmp.x + tmp.y);
        tmp_3.y -= (tmp.y + tmp.x) * bid_cnt;
        // turboFFT_ZMUL_NACC(tmp_1,  rPtr[7], r[(448 + tx / 8) % 3])
        // turboFFT_ZMUL_NACC(tmp_3,  rPtr[7], r[(448 + tx / 8) % 3])
