...
template<>
__global__ void fft_radix_2<float2, 29, 1, 0, 0>(float2* inputs, float2* outputs, float2* twiddle, float2* checksum_DFT, int BS, int thread_bs) {
    int bid_cnt = 0;
...
#include "../../../TurboFFT_radix_2_template.h"
template<>
__global__ void fft_radix_2<float2, 29, 1, 1, 0>(float2* inputs, float2* outputs, float2* twiddle, float2* checksum_DFT, int BS, int thread_bs) {
    int bid_cnt = 0;
...
#include "../../../TurboFFT_radix_2_template.h"
template<>
__global__ void fft_radix_2<float2, 29, 1, 1, 1>(float2* inputs, float2* outputs, float2* twiddle, float2* checksum_DFT, int BS, int thread_bs) {
    int bid_cnt = 0;
    ...
    global_k += tx / 8;
        ...
        turboFFT_ZMUL(angle, tmp, delta_angle);
            ...
            *(gPtr + 491520) = rPtr[30];
            ...
            // rPtr_3[16] = *(gPtr + 524288);
            // turboFFT_ZADD(rPtr_3[16], rPtr_3[16], rPtr[1] );
            // *(gPtr + 524288) = rPtr_3[16];
            *(gPtr + 524288) = rPtr[1];
        
            // rPtr_3[17] = *(gPtr + 557056);
            // turboFFT_ZADD(rPtr_3[17], rPtr_3[17], rPtr[17] );
            // *(gPtr + 557056) = rPtr_3[17];
            *(gPtr + 557056) = rPtr[17];
        
            // rPtr_3[18] = *(gPtr + 589824);
            // turboFFT_ZADD(rPtr_3[18], rPtr_3[18], rPtr[9] );
            // *(gPtr + 589824) = rPtr_3[18];
            *(gPtr + 589824) = rPtr[9];
        
            // rPtr_3[19] = *(gPtr + 622592);
            // turboFFT_ZADD(rPtr_3[19], rPtr_3[19], rPtr[25] );
            // *(gPtr + 622592) = rPtr_3[19];
            *(gPtr + 622592) = rPtr[25];
        
            // rPtr_3[20] = *(gPtr + 655360);
            // turboFFT_ZADD(rPtr_3[20], rPtr_3[20], rPtr[5] );
            // *(gPtr + 655360) = rPtr_3[20];
            *(gPtr + 655360) = rPtr[5];
        
            // rPtr_3[21] = *(gPtr + 688128);
            // turboFFT_ZADD(rPtr_3[21], rPtr_3[21], rPtr[21] );
            // *(gPtr + 688128) = rPtr_3[21];
            *(gPtr + 688128) = rPtr[21];
        
            // rPtr_3[22] = *(gPtr + 720896);
            // turboFFT_ZADD(rPtr_3[22], rPtr_3[22], rPtr[13] );
            // *(gPtr + 720896) = rPtr_3[22];
            *(gPtr + 720896) = rPtr[13];
        
            // rPtr_3[23] = *(gPtr + 753664);
            // turboFFT_ZADD(rPtr_3[23], rPtr_3[23], rPtr[29] );
            // *(gPtr + 753664) = rPtr_3[23];
            *(gPtr + 753664) = rPtr[29];
        
            // rPtr_3[24] = *(gPtr + 786432);
            // turboFFT_ZADD(rPtr_3[24], rPtr_3[24], rPtr[3] );
            // *(gPtr + 786432) = rPtr_3[24];
            *(gPtr + 786432) = rPtr[3];
        
            // rPtr_3[25] = *(gPtr + 819200);
            // turboFFT_ZADD(rPtr_3[25], rPtr_3[25], rPtr[19] );
            // *(gPtr + 819200) = rPtr_3[25];
            *(gPtr + 819200) = rPtr[19];
        
            // rPtr_3[26] = *(gPtr + 851968);
            // turboFFT_ZADD(rPtr_3[26], rPtr_3[26], rPtr[11] );
            // *(gPtr + 851968) = rPtr_3[26];
            *(gPtr + 851968) = rPtr[11];
        
            // rPtr_3[27] = *(gPtr + 884736);
            // turboFFT_ZADD(rPtr_3[27], rPtr_3[27], rPtr[27] );
            // *(gPtr + 884736) = rPtr_3[27];
            *(gPtr + 884736) = rPtr[27];
        
            // rPtr_3[28] = *(gPtr + 917504);
            // turboFFT_ZADD(rPtr_3[28], rPtr_3[28], rPtr[7] );
            // *(gPtr + 917504) = rPtr_3[28];
            *(gPtr + 917504) = rPtr[7];
        
            // rPtr_3[29] = *(gPtr + 950272);
            // turboFFT_ZADD(rPtr_3[29], rPtr_3[29], rPtr[23] );
            // *(gPtr + 950272) = rPtr_3[29];
            *(gPtr + 950272) = rPtr[23];
        
            // rPtr_3[30] = *(gPtr + 983040);
            // turboFFT_ZADD(rPtr_3[30], rPtr_3[30], rPtr[15] );
            // *(gPtr + 983040) = rPtr_3[30];
            *(gPtr + 983040) = rPtr[15];
        
            // rPtr_3[31] = *(gPtr + 1015808);
            // turboFFT_ZADD(rPtr_3[31], rPtr_3[31], rPtr[31] );
            // *(gPtr + 1015808) = rPtr_3[31];
            *(gPtr + 1015808) = rPtr[31];
        }}