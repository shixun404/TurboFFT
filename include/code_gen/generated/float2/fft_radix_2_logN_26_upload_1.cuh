...
template<>
__global__ void fft_radix_2<float2, 26, 1, 0, 0>(float2* inputs, float2* outputs, float2* twiddle, float2* checksum_DFT, int BS, int thread_bs) {
    int bid_cnt = 0;
    ...
    global_k += tx / 32;
        ...
        angle.x = __cosf( global_j * global_k * -4.7936899621426287e-05f);
        angle.y = __sinf( global_j * global_k * -4.7936899621426287e-05f);
...
#include "../../../TurboFFT_radix_2_template.h"
template<>
__global__ void fft_radix_2<float2, 26, 1, 1, 0>(float2* inputs, float2* outputs, float2* twiddle, float2* checksum_DFT, int BS, int thread_bs) {
    int bid_cnt = 0;
    ...
    global_k += tx / 32;
        ...
        turboFFT_ZMUL(tmp, rPtr[8],r[(16 + tx / 32) % 3])
        tmp_1.y -= (tmp.x + tmp.y);
        tmp_3.y -= (tmp.y + tmp.x) * bid_cnt;
        // turboFFT_ZMUL_NACC(tmp_1,  rPtr[8], r[(16 + tx / 32) % 3])
        // turboFFT_ZMUL_NACC(tmp_3,  rPtr[8], r[(16 + tx / 32) % 3])
        ...
        turboFFT_ZMUL(tmp, rPtr[4],r[(32 + tx / 32) % 3])
        tmp_1.y -= (tmp.x + tmp.y);
        tmp_3.y -= (tmp.y + tmp.x) * bid_cnt;
        // turboFFT_ZMUL_NACC(tmp_1,  rPtr[4], r[(32 + tx / 32) % 3])
        // turboFFT_ZMUL_NACC(tmp_3,  rPtr[4], r[(32 + tx / 32) % 3])
        ...
        turboFFT_ZMUL(tmp, rPtr[12],r[(48 + tx / 32) % 3])
        tmp_1.y -= (tmp.x + tmp.y);
        tmp_3.y -= (tmp.y + tmp.x) * bid_cnt;
        // turboFFT_ZMUL_NACC(tmp_1,  rPtr[12], r[(48 + tx / 32) % 3])
        // turboFFT_ZMUL_NACC(tmp_3,  rPtr[12], r[(48 + tx / 32) % 3])
        ...
        turboFFT_ZMUL(tmp, rPtr[2],r[(64 + tx / 32) % 3])
        tmp_1.y -= (tmp.x + tmp.y);
        tmp_3.y -= (tmp.y + tmp.x) * bid_cnt;
        // turboFFT_ZMUL_NACC(tmp_1,  rPtr[2], r[(64 + tx / 32) % 3])
        // turboFFT_ZMUL_NACC(tmp_3,  rPtr[2], r[(64 + tx / 32) % 3])
        ...
        turboFFT_ZMUL(tmp, rPtr[10],r[(80 + tx / 32) % 3])
        tmp_1.y -= (tmp.x + tmp.y);
        tmp_3.y -= (tmp.y + tmp.x) * bid_cnt;
        // turboFFT_ZMUL_NACC(tmp_1,  rPtr[10], r[(80 + tx / 32) % 3])
        // turboFFT_ZMUL_NACC(tmp_3,  rPtr[10], r[(80 + tx / 32) % 3])
        ...
        turboFFT_ZMUL(tmp, rPtr[6],r[(96 + tx / 32) % 3])
        tmp_1.y -= (tmp.x + tmp.y);
        tmp_3.y -= (tmp.y + tmp.x) * bid_cnt;
        // turboFFT_ZMUL_NACC(tmp_1,  rPtr[6], r[(96 + tx / 32) % 3])
        // turboFFT_ZMUL_NACC(tmp_3,  rPtr[6], r[(96 + tx / 32) % 3])
        ...
        turboFFT_ZMUL(tmp, rPtr[14],r[(112 + tx / 32) % 3])
        tmp_1.y -= (tmp.x + tmp.y);
        tmp_3.y -= (tmp.y + tmp.x) * bid_cnt;
        // turboFFT_ZMUL_NACC(tmp_1,  rPtr[14], r[(112 + tx / 32) % 3])
        // turboFFT_ZMUL_NACC(tmp_3,  rPtr[14], r[(112 + tx / 32) % 3])
        ...
        turboFFT_ZMUL(tmp, rPtr[1],r[(128 + tx / 32) % 3])
        tmp_1.y -= (tmp.x + tmp.y);
        tmp_3.y -= (tmp.y + tmp.x) * bid_cnt;
        // turboFFT_ZMUL_NACC(tmp_1,  rPtr[1], r[(128 + tx / 32) % 3])
        // turboFFT_ZMUL_NACC(tmp_3,  rPtr[1], r[(128 + tx / 32) % 3])
        ...
        turboFFT_ZMUL(tmp, rPtr[9],r[(144 + tx / 32) % 3])
        tmp_1.y -= (tmp.x + tmp.y);
        tmp_3.y -= (tmp.y + tmp.x) * bid_cnt;
        // turboFFT_ZMUL_NACC(tmp_1,  rPtr[9], r[(144 + tx / 32) % 3])
        // turboFFT_ZMUL_NACC(tmp_3,  rPtr[9], r[(144 + tx / 32) % 3])
        ...
        turboFFT_ZMUL(tmp, rPtr[5],r[(160 + tx / 32) % 3])
        tmp_1.y -= (tmp.x + tmp.y);
        tmp_3.y -= (tmp.y + tmp.x) * bid_cnt;
        // turboFFT_ZMUL_NACC(tmp_1,  rPtr[5], r[(160 + tx / 32) % 3])
        // turboFFT_ZMUL_NACC(tmp_3,  rPtr[5], r[(160 + tx / 32) % 3])
        ...
        turboFFT_ZMUL(tmp, rPtr[13],r[(176 + tx / 32) % 3])
        tmp_1.y -= (tmp.x + tmp.y);
        tmp_3.y -= (tmp.y + tmp.x) * bid_cnt;
        // turboFFT_ZMUL_NACC(tmp_1,  rPtr[13], r[(176 + tx / 32) % 3])
        // turboFFT_ZMUL_NACC(tmp_3,  rPtr[13], r[(176 + tx / 32) % 3])
        ...
        turboFFT_ZMUL(tmp, rPtr[3],r[(192 + tx / 32) % 3])
        tmp_1.y -= (tmp.x + tmp.y);
        tmp_3.y -= (tmp.y + tmp.x) * bid_cnt;
        // turboFFT_ZMUL_NACC(tmp_1,  rPtr[3], r[(192 + tx / 32) % 3])
        // turboFFT_ZMUL_NACC(tmp_3,  rPtr[3], r[(192 + tx / 32) % 3])
        ...
        turboFFT_ZMUL(tmp, rPtr[11],r[(208 + tx / 32) % 3])
        tmp_1.y -= (tmp.x + tmp.y);
        tmp_3.y -= (tmp.y + tmp.x) * bid_cnt;
        // turboFFT_ZMUL_NACC(tmp_1,  rPtr[11], r[(208 + tx / 32) % 3])
        // turboFFT_ZMUL_NACC(tmp_3,  rPtr[11], r[(208 + tx / 32) % 3])
        ...
        turboFFT_ZMUL(tmp, rPtr[7],r[(224 + tx / 32) % 3])
        tmp_1.y -= (tmp.x + tmp.y);
        tmp_3.y -= (tmp.y + tmp.x) * bid_cnt;
        // turboFFT_ZMUL_NACC(tmp_1,  rPtr[7], r[(224 + tx / 32) % 3])
        // turboFFT_ZMUL_NACC(tmp_3,  rPtr[7], r[(224 + tx / 32) % 3])
        ...
        turboFFT_ZMUL(tmp, rPtr[15],r[(240 + tx / 32) % 3])
        tmp_1.y -= (tmp.x + tmp.y);
        tmp_3.y -= (tmp.y + tmp.x) * bid_cnt;
        // turboFFT_ZMUL_NACC(tmp_1,  rPtr[15], r[(240 + tx / 32) % 3])
        // turboFFT_ZMUL_NACC(tmp_3,  rPtr[15], r[(240 + tx / 32) % 3])
        ...
        // 1's vector
        // tmp.x = (tx / 32 == 0) ? (rPtr_3[0].y + rPtr_3[0].x) * 256: 0;
        // tmp.y = (tx / 32 == 0) ? (abs(rPtr_3[0].y) + abs(rPtr_3[0].x)) * 256: 0;
        tmp = tmp_1;
        tmp_1.y += tmp.x;
...
#include "../../../TurboFFT_radix_2_template.h"
template<>
__global__ void fft_radix_2<float2, 26, 1, 1, 1>(float2* inputs, float2* outputs, float2* twiddle, float2* checksum_DFT, int BS, int thread_bs) {
    int bid_cnt = 0;
    ...
    global_k += tx / 32;
        ...
        turboFFT_ZMUL(angle, tmp, delta_angle);
            ...
            *(gPtr + 73728) = rPtr[9];
            ...
            // rPtr_3[10] = *(gPtr + 81920);
            // turboFFT_ZADD(rPtr_3[10], rPtr_3[10], rPtr[5] );
            // *(gPtr + 81920) = rPtr_3[10];
            *(gPtr + 81920) = rPtr[5];
        
            // rPtr_3[11] = *(gPtr + 90112);
            // turboFFT_ZADD(rPtr_3[11], rPtr_3[11], rPtr[13] );
            // *(gPtr + 90112) = rPtr_3[11];
            *(gPtr + 90112) = rPtr[13];
        
            // rPtr_3[12] = *(gPtr + 98304);
            // turboFFT_ZADD(rPtr_3[12], rPtr_3[12], rPtr[3] );
            // *(gPtr + 98304) = rPtr_3[12];
            *(gPtr + 98304) = rPtr[3];
        
            // rPtr_3[13] = *(gPtr + 106496);
            // turboFFT_ZADD(rPtr_3[13], rPtr_3[13], rPtr[11] );
            // *(gPtr + 106496) = rPtr_3[13];
            *(gPtr + 106496) = rPtr[11];
        
            // rPtr_3[14] = *(gPtr + 114688);
            // turboFFT_ZADD(rPtr_3[14], rPtr_3[14], rPtr[7] );
            // *(gPtr + 114688) = rPtr_3[14];
            *(gPtr + 114688) = rPtr[7];
        
            // rPtr_3[15] = *(gPtr + 122880);
            // turboFFT_ZADD(rPtr_3[15], rPtr_3[15], rPtr[15] );
            // *(gPtr + 122880) = rPtr_3[15];
            *(gPtr + 122880) = rPtr[15];
        }}