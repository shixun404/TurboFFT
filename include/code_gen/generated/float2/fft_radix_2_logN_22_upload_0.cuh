...
__global__ void fft_radix_2<float2, 22, 0, 0, 0>(float2* inputs, float2* outputs, float2* twiddle, float2* checksum_DFT, int BS, int thread_bs) {
    ...
    for(bid = (blockIdx.x / tb_gap) * tb_gap * thread_bs + blockIdx.x % tb_gap;
                bid_cnt < thread_bs && bid < (4194304 * BS + 8192 - 1) / 8192; bid += delta_bid)
    {
    bid_cnt += 1;
    ...
    global_k += tx / 4;
        ...
        angle.x = __cosf( global_j * global_k * -1.4980281131695715e-06f);
        angle.y = __sinf( global_j * global_k * -1.4980281131695715e-06f);
    ...
    global_k += tx / 4;
        ...
        turboFFT_ZMUL(angle, tmp, delta_angle);
            ...
            *(gPtr + 0) = rPtr[0];
            ...
            // rPtr_3[1] = *(gPtr + 131072);
            // turboFFT_ZADD(rPtr_3[1], rPtr_3[1], rPtr[1] );
            // *(gPtr + 131072) = rPtr_3[1];
            *(gPtr + 131072) = rPtr[1];
        
            // rPtr_3[2] = *(gPtr + 262144);
            // turboFFT_ZADD(rPtr_3[2], rPtr_3[2], rPtr[2] );
            // *(gPtr + 262144) = rPtr_3[2];
            *(gPtr + 262144) = rPtr[2];
        
            // rPtr_3[3] = *(gPtr + 393216);
            // turboFFT_ZADD(rPtr_3[3], rPtr_3[3], rPtr[3] );
            // *(gPtr + 393216) = rPtr_3[3];
            *(gPtr + 393216) = rPtr[3];
        
            // rPtr_3[4] = *(gPtr + 524288);
            // turboFFT_ZADD(rPtr_3[4], rPtr_3[4], rPtr[4] );
            // *(gPtr + 524288) = rPtr_3[4];
            *(gPtr + 524288) = rPtr[4];
        
            // rPtr_3[5] = *(gPtr + 655360);
            // turboFFT_ZADD(rPtr_3[5], rPtr_3[5], rPtr[5] );
            // *(gPtr + 655360) = rPtr_3[5];
            *(gPtr + 655360) = rPtr[5];
        
            // rPtr_3[6] = *(gPtr + 786432);
            // turboFFT_ZADD(rPtr_3[6], rPtr_3[6], rPtr[6] );
            // *(gPtr + 786432) = rPtr_3[6];
            *(gPtr + 786432) = rPtr[6];
        
            // rPtr_3[7] = *(gPtr + 917504);
            // turboFFT_ZADD(rPtr_3[7], rPtr_3[7], rPtr[7] );
            // *(gPtr + 917504) = rPtr_3[7];
            *(gPtr + 917504) = rPtr[7];
        
            // rPtr_3[8] = *(gPtr + 1048576);
            // turboFFT_ZADD(rPtr_3[8], rPtr_3[8], rPtr[8] );
            // *(gPtr + 1048576) = rPtr_3[8];
            *(gPtr + 1048576) = rPtr[8];
        
            // rPtr_3[9] = *(gPtr + 1179648);
            // turboFFT_ZADD(rPtr_3[9], rPtr_3[9], rPtr[9] );
            // *(gPtr + 1179648) = rPtr_3[9];
            *(gPtr + 1179648) = rPtr[9];
        
            // rPtr_3[10] = *(gPtr + 1310720);
            // turboFFT_ZADD(rPtr_3[10], rPtr_3[10], rPtr[10] );
            // *(gPtr + 1310720) = rPtr_3[10];
            *(gPtr + 1310720) = rPtr[10];
        
            // rPtr_3[11] = *(gPtr + 1441792);
            // turboFFT_ZADD(rPtr_3[11], rPtr_3[11], rPtr[11] );
            // *(gPtr + 1441792) = rPtr_3[11];
            *(gPtr + 1441792) = rPtr[11];
        
            // rPtr_3[12] = *(gPtr + 1572864);
            // turboFFT_ZADD(rPtr_3[12], rPtr_3[12], rPtr[12] );
            // *(gPtr + 1572864) = rPtr_3[12];
            *(gPtr + 1572864) = rPtr[12];
        
            // rPtr_3[13] = *(gPtr + 1703936);
            // turboFFT_ZADD(rPtr_3[13], rPtr_3[13], rPtr[13] );
            // *(gPtr + 1703936) = rPtr_3[13];
            *(gPtr + 1703936) = rPtr[13];
        
            // rPtr_3[14] = *(gPtr + 1835008);
            // turboFFT_ZADD(rPtr_3[14], rPtr_3[14], rPtr[14] );
            // *(gPtr + 1835008) = rPtr_3[14];
            *(gPtr + 1835008) = rPtr[14];
        
            // rPtr_3[15] = *(gPtr + 1966080);
            // turboFFT_ZADD(rPtr_3[15], rPtr_3[15], rPtr[15] );
            // *(gPtr + 1966080) = rPtr_3[15];
            *(gPtr + 1966080) = rPtr[15];
        
            // rPtr_3[16] = *(gPtr + 2097152);
            // turboFFT_ZADD(rPtr_3[16], rPtr_3[16], rPtr[16] );
            // *(gPtr + 2097152) = rPtr_3[16];
            *(gPtr + 2097152) = rPtr[16];
        
            // rPtr_3[17] = *(gPtr + 2228224);
            // turboFFT_ZADD(rPtr_3[17], rPtr_3[17], rPtr[17] );
            // *(gPtr + 2228224) = rPtr_3[17];
            *(gPtr + 2228224) = rPtr[17];
        
            // rPtr_3[18] = *(gPtr + 2359296);
            // turboFFT_ZADD(rPtr_3[18], rPtr_3[18], rPtr[18] );
            // *(gPtr + 2359296) = rPtr_3[18];
            *(gPtr + 2359296) = rPtr[18];
        
            // rPtr_3[19] = *(gPtr + 2490368);
            // turboFFT_ZADD(rPtr_3[19], rPtr_3[19], rPtr[19] );
            // *(gPtr + 2490368) = rPtr_3[19];
            *(gPtr + 2490368) = rPtr[19];
        
            // rPtr_3[20] = *(gPtr + 2621440);
            // turboFFT_ZADD(rPtr_3[20], rPtr_3[20], rPtr[20] );
            // *(gPtr + 2621440) = rPtr_3[20];
            *(gPtr + 2621440) = rPtr[20];
        
            // rPtr_3[21] = *(gPtr + 2752512);
            // turboFFT_ZADD(rPtr_3[21], rPtr_3[21], rPtr[21] );
            // *(gPtr + 2752512) = rPtr_3[21];
            *(gPtr + 2752512) = rPtr[21];
        
            // rPtr_3[22] = *(gPtr + 2883584);
            // turboFFT_ZADD(rPtr_3[22], rPtr_3[22], rPtr[22] );
            // *(gPtr + 2883584) = rPtr_3[22];
            *(gPtr + 2883584) = rPtr[22];
        
            // rPtr_3[23] = *(gPtr + 3014656);
            // turboFFT_ZADD(rPtr_3[23], rPtr_3[23], rPtr[23] );
            // *(gPtr + 3014656) = rPtr_3[23];
            *(gPtr + 3014656) = rPtr[23];
        
            // rPtr_3[24] = *(gPtr + 3145728);
            // turboFFT_ZADD(rPtr_3[24], rPtr_3[24], rPtr[24] );
            // *(gPtr + 3145728) = rPtr_3[24];
            *(gPtr + 3145728) = rPtr[24];
        
            // rPtr_3[25] = *(gPtr + 3276800);
            // turboFFT_ZADD(rPtr_3[25], rPtr_3[25], rPtr[25] );
            // *(gPtr + 3276800) = rPtr_3[25];
            *(gPtr + 3276800) = rPtr[25];
        
            // rPtr_3[26] = *(gPtr + 3407872);
            // turboFFT_ZADD(rPtr_3[26], rPtr_3[26], rPtr[26] );
            // *(gPtr + 3407872) = rPtr_3[26];
            *(gPtr + 3407872) = rPtr[26];
        
            // rPtr_3[27] = *(gPtr + 3538944);
            // turboFFT_ZADD(rPtr_3[27], rPtr_3[27], rPtr[27] );
            // *(gPtr + 3538944) = rPtr_3[27];
            *(gPtr + 3538944) = rPtr[27];
        
            // rPtr_3[28] = *(gPtr + 3670016);
            // turboFFT_ZADD(rPtr_3[28], rPtr_3[28], rPtr[28] );
            // *(gPtr + 3670016) = rPtr_3[28];
            *(gPtr + 3670016) = rPtr[28];
        
            // rPtr_3[29] = *(gPtr + 3801088);
            // turboFFT_ZADD(rPtr_3[29], rPtr_3[29], rPtr[29] );
            // *(gPtr + 3801088) = rPtr_3[29];
            *(gPtr + 3801088) = rPtr[29];
        
            // rPtr_3[30] = *(gPtr + 3932160);
            // turboFFT_ZADD(rPtr_3[30], rPtr_3[30], rPtr[30] );
            // *(gPtr + 3932160) = rPtr_3[30];
            *(gPtr + 3932160) = rPtr[30];
        
            // rPtr_3[31] = *(gPtr + 4063232);
            // turboFFT_ZADD(rPtr_3[31], rPtr_3[31], rPtr[31] );
            // *(gPtr + 4063232) = rPtr_3[31];
            *(gPtr + 4063232) = rPtr[31];
        }}