...
template<>
__global__ void fft_radix_2<float2, 28, 0, 0, 0>(float2* inputs, float2* outputs, float2* twiddle, float2* checksum_DFT, int BS, int thread_bs) {
    int bid_cnt = 0;
    ...
    gPtr += (bx % BS * 268435456);
        ...
        rPtr[1] = *(gPtr + 16777216);
        rPtr_3[1].x += rPtr[1].x;
        rPtr_3[1].y += rPtr[1].y;
        
        rPtr[2] = *(gPtr + 33554432);
        rPtr_3[2].x += rPtr[2].x;
        rPtr_3[2].y += rPtr[2].y;
        
        rPtr[3] = *(gPtr + 50331648);
        rPtr_3[3].x += rPtr[3].x;
        rPtr_3[3].y += rPtr[3].y;
        
        rPtr[4] = *(gPtr + 67108864);
        rPtr_3[4].x += rPtr[4].x;
        rPtr_3[4].y += rPtr[4].y;
        
        rPtr[5] = *(gPtr + 83886080);
        rPtr_3[5].x += rPtr[5].x;
        rPtr_3[5].y += rPtr[5].y;
        
        rPtr[6] = *(gPtr + 100663296);
        rPtr_3[6].x += rPtr[6].x;
        rPtr_3[6].y += rPtr[6].y;
        
        rPtr[7] = *(gPtr + 117440512);
        rPtr_3[7].x += rPtr[7].x;
        rPtr_3[7].y += rPtr[7].y;
        
        rPtr[8] = *(gPtr + 134217728);
        rPtr_3[8].x += rPtr[8].x;
        rPtr_3[8].y += rPtr[8].y;
        
        rPtr[9] = *(gPtr + 150994944);
        rPtr_3[9].x += rPtr[9].x;
        rPtr_3[9].y += rPtr[9].y;
        
        rPtr[10] = *(gPtr + 167772160);
        rPtr_3[10].x += rPtr[10].x;
        rPtr_3[10].y += rPtr[10].y;
        
        rPtr[11] = *(gPtr + 184549376);
        rPtr_3[11].x += rPtr[11].x;
        rPtr_3[11].y += rPtr[11].y;
        
        rPtr[12] = *(gPtr + 201326592);
        rPtr_3[12].x += rPtr[12].x;
        rPtr_3[12].y += rPtr[12].y;
        
        rPtr[13] = *(gPtr + 218103808);
        rPtr_3[13].x += rPtr[13].x;
        rPtr_3[13].y += rPtr[13].y;
        
        rPtr[14] = *(gPtr + 234881024);
        rPtr_3[14].x += rPtr[14].x;
        rPtr_3[14].y += rPtr[14].y;
        
        rPtr[15] = *(gPtr + 251658240);
    ...
    global_k += tx / 16;
        ...
        delta_angle.x = __cosf(global_j *  -7.490140774280007e-07f);
        delta_angle.y = __sinf(global_j *  -7.490140774280007e-07f);
        angle.x = __cosf( global_j * global_k * -2.3406689268274554e-08f);
        angle.y = __sinf( global_j * global_k * -2.3406689268274554e-08f);
        ...
        turboFFT_ZMUL(angle, tmp, delta_angle);
            ...
            *(gPtr + 16777216) = rPtr[1];
            rPtr_4[1].x += rPtr[1].x;
            rPtr_4[1].y += rPtr[1].y;
            
            *(gPtr + 33554432) = rPtr[2];
            rPtr_4[2].x += rPtr[2].x;
            rPtr_4[2].y += rPtr[2].y;
            
            *(gPtr + 50331648) = rPtr[3];
            rPtr_4[3].x += rPtr[3].x;
            rPtr_4[3].y += rPtr[3].y;
            
            *(gPtr + 67108864) = rPtr[4];
            rPtr_4[4].x += rPtr[4].x;
            rPtr_4[4].y += rPtr[4].y;
            
            *(gPtr + 83886080) = rPtr[5];
            rPtr_4[5].x += rPtr[5].x;
            rPtr_4[5].y += rPtr[5].y;
            ...
            *(gPtr + 117440512) = rPtr[7];
            rPtr_4[7].x += rPtr[7].x;
            rPtr_4[7].y += rPtr[7].y;
            
            *(gPtr + 134217728) = rPtr[8];
            rPtr_4[8].x += rPtr[8].x;
            rPtr_4[8].y += rPtr[8].y;
...
#include "../../../TurboFFT_radix_2_template.h"
template<>
__global__ void fft_radix_2<float2, 28, 0, 1, 0>(float2* inputs, float2* outputs, float2* twiddle, float2* checksum_DFT, int BS, int thread_bs) {
    int bid_cnt = 0;
...
#include "../../../TurboFFT_radix_2_template.h"
template<>
__global__ void fft_radix_2<float2, 28, 0, 1, 1>(float2* inputs, float2* outputs, float2* twiddle, float2* checksum_DFT, int BS, int thread_bs) {
    int bid_cnt = 0;
    ...
    global_k += tx / 16;
        ...
        turboFFT_ZMUL(angle, tmp, delta_angle);
            ...
            *(gPtr + 0) = rPtr[0];
            ...
            // rPtr_3[1] = *(gPtr + 16777216);
            // turboFFT_ZADD(rPtr_3[1], rPtr_3[1], rPtr[1] );
            // *(gPtr + 16777216) = rPtr_3[1];
            *(gPtr + 16777216) = rPtr[1];
        
            // rPtr_3[2] = *(gPtr + 33554432);
            // turboFFT_ZADD(rPtr_3[2], rPtr_3[2], rPtr[2] );
            // *(gPtr + 33554432) = rPtr_3[2];
            *(gPtr + 33554432) = rPtr[2];
        
            // rPtr_3[3] = *(gPtr + 50331648);
            // turboFFT_ZADD(rPtr_3[3], rPtr_3[3], rPtr[3] );
            // *(gPtr + 50331648) = rPtr_3[3];
            *(gPtr + 50331648) = rPtr[3];
        
            // rPtr_3[4] = *(gPtr + 67108864);
            // turboFFT_ZADD(rPtr_3[4], rPtr_3[4], rPtr[4] );
            // *(gPtr + 67108864) = rPtr_3[4];
            *(gPtr + 67108864) = rPtr[4];
        
            // rPtr_3[5] = *(gPtr + 83886080);
            // turboFFT_ZADD(rPtr_3[5], rPtr_3[5], rPtr[5] );
            // *(gPtr + 83886080) = rPtr_3[5];
            *(gPtr + 83886080) = rPtr[5];
        
            // rPtr_3[6] = *(gPtr + 100663296);
            // turboFFT_ZADD(rPtr_3[6], rPtr_3[6], rPtr[6] );
            // *(gPtr + 100663296) = rPtr_3[6];
            *(gPtr + 100663296) = rPtr[6];
        
            // rPtr_3[7] = *(gPtr + 117440512);
            // turboFFT_ZADD(rPtr_3[7], rPtr_3[7], rPtr[7] );
            // *(gPtr + 117440512) = rPtr_3[7];
            *(gPtr + 117440512) = rPtr[7];
        
            // rPtr_3[8] = *(gPtr + 134217728);
            // turboFFT_ZADD(rPtr_3[8], rPtr_3[8], rPtr[8] );
            // *(gPtr + 134217728) = rPtr_3[8];
            *(gPtr + 134217728) = rPtr[8];
        
            // rPtr_3[9] = *(gPtr + 150994944);
            // turboFFT_ZADD(rPtr_3[9], rPtr_3[9], rPtr[9] );
            // *(gPtr + 150994944) = rPtr_3[9];
            *(gPtr + 150994944) = rPtr[9];
        
            // rPtr_3[10] = *(gPtr + 167772160);
            // turboFFT_ZADD(rPtr_3[10], rPtr_3[10], rPtr[10] );
            // *(gPtr + 167772160) = rPtr_3[10];
            *(gPtr + 167772160) = rPtr[10];
        
            // rPtr_3[11] = *(gPtr + 184549376);
            // turboFFT_ZADD(rPtr_3[11], rPtr_3[11], rPtr[11] );
            // *(gPtr + 184549376) = rPtr_3[11];
            *(gPtr + 184549376) = rPtr[11];
        
            // rPtr_3[12] = *(gPtr + 201326592);
            // turboFFT_ZADD(rPtr_3[12], rPtr_3[12], rPtr[12] );
            // *(gPtr + 201326592) = rPtr_3[12];
            *(gPtr + 201326592) = rPtr[12];
        
            // rPtr_3[13] = *(gPtr + 218103808);
            // turboFFT_ZADD(rPtr_3[13], rPtr_3[13], rPtr[13] );
            // *(gPtr + 218103808) = rPtr_3[13];
            *(gPtr + 218103808) = rPtr[13];
        
            // rPtr_3[14] = *(gPtr + 234881024);
            // turboFFT_ZADD(rPtr_3[14], rPtr_3[14], rPtr[14] );
            // *(gPtr + 234881024) = rPtr_3[14];
            *(gPtr + 234881024) = rPtr[14];
        
            // rPtr_3[15] = *(gPtr + 251658240);
            // turboFFT_ZADD(rPtr_3[15], rPtr_3[15], rPtr[15] );
            // *(gPtr + 251658240) = rPtr_3[15];
            *(gPtr + 251658240) = rPtr[15];
        }}