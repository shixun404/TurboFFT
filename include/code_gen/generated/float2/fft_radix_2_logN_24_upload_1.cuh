...
__global__ void fft_radix_2<float2, 24, 1, 0, 0>(float2* inputs, float2* outputs, float2* twiddle, float2* checksum_DFT, int BS, int thread_bs) {
    ...
    for(bid = (blockIdx.x / tb_gap) * tb_gap * thread_bs + blockIdx.x % tb_gap;
                bid_cnt < thread_bs && bid < (16777216 * BS + 4096 - 1) / 4096; bid += delta_bid)
    {
    bid_cnt += 1;
    ...
    global_k += tx / 64;
        ...
        angle.x = __cosf( global_j * global_k * -0.00019174759848570515f);
        angle.y = __sinf( global_j * global_k * -0.00019174759848570515f);
...
__global__ void fft_radix_2<float2, 24, 1, 1, 0>(float2* inputs, float2* outputs, float2* twiddle, float2* checksum_DFT, int BS, int thread_bs) {
    ...
    global_k += tx / 64;
        ...
        turboFFT_ZMUL(tmp, rPtr[0],r[(0 + tx / 64) % 3])
        tmp_1.y -= (tmp.x + tmp.y);
        tmp_3.y -= (tmp.y + tmp.x) * bid_cnt;
        // turboFFT_ZMUL_NACC(tmp_1,  rPtr[0], r[(0 + tx / 64) % 3])
        // turboFFT_ZMUL_NACC(tmp_3,  rPtr[0], r[(0 + tx / 64) % 3])
        ...
        turboFFT_ZMUL(tmp, rPtr[4],r[(8 + tx / 64) % 3])
        tmp_1.y -= (tmp.x + tmp.y);
        tmp_3.y -= (tmp.y + tmp.x) * bid_cnt;
        // turboFFT_ZMUL_NACC(tmp_1,  rPtr[4], r[(8 + tx / 64) % 3])
        // turboFFT_ZMUL_NACC(tmp_3,  rPtr[4], r[(8 + tx / 64) % 3])
        ...
        turboFFT_ZMUL(tmp, rPtr[2],r[(16 + tx / 64) % 3])
        tmp_1.y -= (tmp.x + tmp.y);
        tmp_3.y -= (tmp.y + tmp.x) * bid_cnt;
        // turboFFT_ZMUL_NACC(tmp_1,  rPtr[2], r[(16 + tx / 64) % 3])
        // turboFFT_ZMUL_NACC(tmp_3,  rPtr[2], r[(16 + tx / 64) % 3])
        ...
        turboFFT_ZMUL(tmp, rPtr[6],r[(24 + tx / 64) % 3])
        tmp_1.y -= (tmp.x + tmp.y);
        tmp_3.y -= (tmp.y + tmp.x) * bid_cnt;
        // turboFFT_ZMUL_NACC(tmp_1,  rPtr[6], r[(24 + tx / 64) % 3])
        // turboFFT_ZMUL_NACC(tmp_3,  rPtr[6], r[(24 + tx / 64) % 3])
        ...
        turboFFT_ZMUL(tmp, rPtr[1],r[(32 + tx / 64) % 3])
        tmp_1.y -= (tmp.x + tmp.y);
        tmp_3.y -= (tmp.y + tmp.x) * bid_cnt;
        // turboFFT_ZMUL_NACC(tmp_1,  rPtr[1], r[(32 + tx / 64) % 3])
        // turboFFT_ZMUL_NACC(tmp_3,  rPtr[1], r[(32 + tx / 64) % 3])
        ...
        turboFFT_ZMUL(tmp, rPtr[5],r[(40 + tx / 64) % 3])
        tmp_1.y -= (tmp.x + tmp.y);
        tmp_3.y -= (tmp.y + tmp.x) * bid_cnt;
        // turboFFT_ZMUL_NACC(tmp_1,  rPtr[5], r[(40 + tx / 64) % 3])
        // turboFFT_ZMUL_NACC(tmp_3,  rPtr[5], r[(40 + tx / 64) % 3])
        ...
        turboFFT_ZMUL(tmp, rPtr[3],r[(48 + tx / 64) % 3])
        tmp_1.y -= (tmp.x + tmp.y);
        tmp_3.y -= (tmp.y + tmp.x) * bid_cnt;
        // turboFFT_ZMUL_NACC(tmp_1,  rPtr[3], r[(48 + tx / 64) % 3])
        // turboFFT_ZMUL_NACC(tmp_3,  rPtr[3], r[(48 + tx / 64) % 3])
        ...
        turboFFT_ZMUL(tmp, rPtr[7],r[(56 + tx / 64) % 3])
        tmp_1.y -= (tmp.x + tmp.y);
        tmp_3.y -= (tmp.y + tmp.x) * bid_cnt;
        // turboFFT_ZMUL_NACC(tmp_1,  rPtr[7], r[(56 + tx / 64) % 3])
        // turboFFT_ZMUL_NACC(tmp_3,  rPtr[7], r[(56 + tx / 64) % 3])
        ...
        // 1's vector
        // tmp.x = (tx / 64 == 0) ? (rPtr_3[0].y + rPtr_3[0].x) * 64: 0;
        // tmp.y = (tx / 64 == 0) ? (abs(rPtr_3[0].y) + abs(rPtr_3[0].x)) * 64: 0;
        tmp = tmp_1;
        tmp_1.y += tmp.x;
        tmp_1.x = (abs(tmp.y) + abs(tmp.x));
        
        // 1's vector
        // tmp.x = (tx / 64 == 0) ? tmp_3.x : 0;
        tmp.x = tmp_3.x;
