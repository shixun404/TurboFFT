...
if __name__ == '__main__':
    ...
    surface_z = [6, 1.5, 2.5, 1.5, 1, 0.3, 0.2, 0.3]
    zticks = [[0, 2, 4, 6], [0, 0.5, 1, 1.5], [0, 1, 2, 2.5], [0, 0.5, 1, 1.5], [0, 0.5, 1], [0, 0.1, 0.2, 0.3], [0, 0.1, 0.2], [0, 0.1, 0.2, 0.3]]
    ...
    plt.rcParams['hatch.linewidth'] = 2.0
    fig = plt.figure(figsize=(20, 10))
    name_lists = [['Benchmark=1_cuFFT_FP32.csv','Benchmark=1_TurboFFT_FP32.csv'], 
                     ]
    title_list = [['Compute Performance\n     A100 FP32   ', 'Memory Bandwidth\n   A100 FP32  '], 
               ]
