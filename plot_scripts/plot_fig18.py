...
def print_average(tensor, name):
    ...
    print(name, avg)
    print(tensor.sort())
file_name_lists = ['../artifact_data/Benchmark=2_cuFFT_FP64.csv', 
                  '../artifact_data/Benchmark=2_TurboFFT_FP64.csv',
                  '../artifact_data/Benchmark=2_TurboFFT_FP64_FT_BS=1.csv',
                  '../artifact_data/Benchmark=2_TurboFFT_FP64_ERR_BS=32.csv',
                  '../artifact_data/Benchmark=2_cuFFT_FP32.csv', 
                  '../artifact_data/Benchmark=2_TurboFFT_FP32.csv',
                  '../artifact_data/Benchmark=2_TurboFFT_FP32_FT_BS=1.csv',
                  '../artifact_data/Benchmark=2_TurboFFT_FP32_ERR_BS=32.csv',
                  '../artifact_data/Benchmark=2_Offline_FP64_ERR.csv',
                  '../artifact_data/Benchmark=2_Offline_FP32_ERR.csv',]
