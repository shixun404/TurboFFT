...
#define turboFFT_ZADD_THREAD_FT(c, a, b) c.x = a.x + b.y; c.y = a.y + b.x; c.x += a.x + b.x; c.y += a.y + b.y;
#define turboFFT_ZSUB_THREAD_FT(c, a, b) c.x = a.x - b.y; c.y = a.y - b.x; c.x += a.x - b.x; c.y += a.y - b.y;
#define turboFFT_ZMUL_THREAD_FT(c, a, b) c.x = a.x * b.x; c.x -= a.y * b.y; c.y = a.y * b.x; c.y += a.x * b.y; \
